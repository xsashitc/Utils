...
public class LogUtil {
    ...
    private static String getLogInfo(StackTraceElement stackTraceElement){
        ...
        String funName = stackTraceElement.getMethodName();
        return "(" + funName +":" +lineNumber+")";
    }
    ...
    public static void d(String tag, String content){
        if (LEVEL <= DEBUG) {
            ...
            Log.d(tag + getLogInfo(stackTraceElement), content);
        }
    }
    ...
    public static void e(String tag, String message, Exception exception){
        if (LEVEL <= ERROR) {
            ...
            Log.e(tag + getLogInfo(stackTraceElement), message, exception);
        }
    }
}
